                    ...
                    <div class="modal-body">
                        <form id="frm-menu" method="post" data-parsley-validate="">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="course_no" name="course_no" data-parsley-required="" data-parsley-required-message="Course no is required" autocomplete="off">
                            </div>
                            <div class="form-group">
...
<script>
    $(document).ready(function(){
        var table = $('#tbl-data').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '<?php echo BASE_URL ?>/api/subjects/get.php',
                    type: 'POST'
                },
                "columnDefs": [ {
                    "targets": [5],
