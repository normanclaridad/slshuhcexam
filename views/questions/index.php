...
require_once('../../models/Subject_offered.php');
...
$resSubjects = $subjectOffered->getWhere("AND is_active = 'Y'", "name asc");
                ...
                <div class="card-body">
                    <h4 class="card-title">
                        ...
                        <span class="float-end">
                            <button onclick="location.href='<?php echo BASE_URL ?>/views/questions/add.php'" class="btn btn-outline-secondary btn-rounded btn-icon btn-sm" id="btn-add">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="frm-modal" method="post" data-parsley-validate="">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="question" name="question" data-parsley-required="" data-parsley-required-message="Description is required." autocomplete="off">
                            </div>       
...
<script>
    $(document).ready(function(){
        var table = $('#tbl-data').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '<?php echo BASE_URL ?>/api/questions/get.php',
                    type: 'POST'
                },
                "columnDefs": [ {
                    "targets": [4],
            ...
            $('#btn-save').click(function(){
                if(!$('form#frm-modal').parsley().validate()) {
                    return;
                }
                var msg = $('.error-message');
                $.ajax({
                    url : '<?php echo BASE_URL ?>/api/subjects/dml.php',
                    type : 'post',
