...
class Schools extends Models {
	...
	public function getJoinWhere($where = '', $sortBy = 's.id DESC', $startFrom = 0, $pageNo = 20, $enableLimit = 'Y') {
		$sql = "SELECT s.*, brgyDesc, cm.citymunDesc, p.provDesc 
                FROM $this->table s
    ...
    public function getTotal($where = '', $sortBy = 's.id DESC') {
